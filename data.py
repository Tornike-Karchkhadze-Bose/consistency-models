...
def get_dataset(name, train):
    if name == 'fmnist':
        ...
        return torchvision.datasets.FashionMNIST(root=f'data/{name}', train=train, download=True, transform=transform)
    elif name == 'mnist':
        transform = torchvision.transforms.Compose([
            torchvision.transforms.Resize(32),
            torchvision.transforms.ToTensor(),
        ...
        return torchvision.datasets.MNIST(root=f'data/{name}', train=train, download=True, transform=transform)
    elif name == 'cifar10':
        transform = torchvision.transforms.Compose([
            torchvision.transforms.RandomHorizontalFlip(),
            torchvision.transforms.ToTensor(),
        ...
        return torchvision.datasets.CIFAR10(root=f'data/{name}', train=train, download=True, transform=transform)
        ...
        return get_butterflies256_dataset(root=f'data/{name}', train=train, transform=transform)
